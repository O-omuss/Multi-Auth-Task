                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('client.register.submit') }}" enctype="multipart/form-data">
                            ...
                            <div class="form-group row">
                                <label for="active_on_social" class="col-md-4 col-form-label text-md-right">{{ __('Active on Social Media') }}</label>

                                <div class="col-md-6">
                                    Yes <input id="active_on_social" type="checkbox" class="@error('active_on_social') is-invalid @enderror" name="active_on_social" value="1"  autocomplete="active_on_social">
                                    
                                    @error('active_on_social')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                                    @enderror
                            ...
                            <div class="form-group row">
                                <label for="active_on_social" class="col-md-4 col-form-label text-md-right">{{ __('Currently') }}</label>

                                <div class="col-md-6">
                                    <select name="currently" class="form-control">
